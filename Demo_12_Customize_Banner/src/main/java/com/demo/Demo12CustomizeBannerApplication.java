...
public class Demo12CustomizeBannerApplication implements CommandLineRunner {

	@Autowired
	OwnerServiceImpl ownerServiceImpl;
	private static final Logger LOGGER = LoggerFactory.getLogger(Demo12CustomizeBannerApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(Demo12CustomizeBannerApplication.class, args);
	}
