...
public class Demo7LoggingApplication implements CommandLineRunner {

	@Autowired
	OwnerServiceImpl ownerServiceImpl;
	private static final Logger LOGGER = LoggerFactory.getLogger(Demo7LoggingApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(Demo7LoggingApplication.class, args);
	}
